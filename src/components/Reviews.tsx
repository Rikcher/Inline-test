...
const Reviews = () => {
    ...
    return (
        <div className='flex flex-col'>
            <p className='mb-6 text-justify lg:text-left max-w-[32.75rem]'>{t("reviews_title")}</p>
            <FormProvider {...methods}>
                <form className='flex flex-col max-w-[37.5rem] lg:max-w-[60rem]' onSubmit={methods.handleSubmit(onSubmit)}>
